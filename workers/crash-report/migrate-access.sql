-- Unify dashboard auth onto id.reames-agent.io: dashboard access is now a per-email
...
-- Apply: wrangler d1 execute reames-agent-crash --remote --file=migrate-access.sql
...
-- admins/viewers keep their access when they next sign in via id.reames-agent.io.
