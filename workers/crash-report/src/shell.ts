...
<header><a class="brand" href="https://reames-agent.io">${LOGO}</a><a class="brand" href="https://reames-agent.io">Reames Agent</a><span class="crumb">/ ${esc(crumb)}</span>${LANG_SWITCH}${nav ? `<span class="nav">${nav}</span>` : ""}</header>
