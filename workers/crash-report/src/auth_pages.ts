...
<p class="sub">Your email and password are managed by your Reames Agent account.</p>
<a class="btn" href="https://reames-agent.io/account/">Manage your account →</a></div>`,
    userNav(user),
  );
}
