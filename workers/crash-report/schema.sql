-- Apply: wrangler d1 execute reames-agent-crash --remote --file=schema.sql
...
-- Legacy local auth — superseded by id.reames-agent.io identity + the `access`
...
-- password, verification) lives in id.reames-agent.io; this only maps email → role.
