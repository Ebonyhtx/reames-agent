-- One-time: add the crash-group summary column to the live reames-agent-crash DB.
-- Apply once: wrangler d1 execute reames-agent-crash --remote --file=migrate-title.sql
