"""Tests for reames_cli.security_advisories.
...
import reames_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full reames_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "reames_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "reames_cli.config.save_config",
