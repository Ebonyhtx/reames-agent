...
import reames_cli.doctor as doctor
import reames_cli.gateway as gateway_cli
from reames_cli import doctor as doctor_mod
from reames_cli.doctor import _has_provider_env_config
...
def test_has_healthy_oauth_fallback_returns_false_for_unknown_provider():
    from reames_cli.doctor import _has_healthy_oauth_fallback_for_apikey_provider
...
class TestHasHealthyOauthFallbackForXai:
    ...
    def test_returns_false_when_xai_import_unavailable(self, monkeypatch):
        ...
        monkeypatch.delattr("reames_cli.auth.get_xai_oauth_auth_status", raising=False)
        # Force doctor module to re-import the function
        monkeypatch.delitem(sys.modules, "reames_cli.doctor", raising=False)
        from reames_cli.doctor import _has_healthy_oauth_fallback_for_apikey_provider
        assert _has_healthy_oauth_fallback_for_apikey_provider("xai") is False
