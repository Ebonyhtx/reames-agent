...
class TestSaveDisabledSkills:
    @patch("reames_cli.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from reames_cli.skills_config import save_disabled_skills
        config = {}
...
class TestIsSkillDisabled:
    @patch("reames_cli.config.load_config")
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from reames_cli.skills_config import _get_categories
        skills = [
