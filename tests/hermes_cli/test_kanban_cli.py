"""Tests for the kanban CLI surface (reames_cli.kanban)."""
...
from reames_cli import kanban as kc
...
def test_kanban_bypasses_active_session_guard():
    from reames_cli.commands import should_bypass_active_session

    assert should_bypass_active_session("kanban")


def test_kanban_in_autocomplete_table():
    from reames_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from reames_cli.commands import COMMAND_REGISTRY
