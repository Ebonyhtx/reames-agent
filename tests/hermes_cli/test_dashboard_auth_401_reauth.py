...
from reames_cli.dashboard_auth import clear_providers, register_provider
...
from tests.reames_cli.conftest_dashboard_auth import StubAuthProvider
...
class TestTransparentRefreshOnAccessTokenEviction:
    ...
    def _build_rt_only_app(self):
        ...
        """
        import time as _t
        from tests.reames_cli.conftest_dashboard_auth import _sign
...
class TestNextSameOriginValidation:
    ...
    def test_safe_next_validator_accepts_same_origin(self):
        from reames_cli.dashboard_auth.middleware import _safe_next_target
...
class TestValidatePostLoginTarget:
    ...
    def test_accepts_same_origin_paths(self):
        from reames_cli.dashboard_auth.routes import _validate_post_login_target
