...
class TestPublicUrlOverride:
    ...
    def patch_config(self, monkeypatch):
        """Replace ``reames_cli.config.load_config`` with a stub
        ...
        def _set(public_url) -> None:
            ...
            monkeypatch.setattr(
                "reames_cli.config.load_config", lambda: cfg
            )
...
class TestCookiePathRespectsPrefix:
    ...
    def test_loopback_cookies_unprefixed(self):
        ...
        from reames_cli.dashboard_auth.cookies import set_pkce_cookie
