#!/usr/bin/env python3
"""
Reames Agent CLI - Interactive Terminal Interface

A beautiful command-line interface for the Reames Agent, inspired by Claude Code.
Features ASCII art branding, interactive REPL, toolset selection, and rich formatting.

Usage:
    python cli.py                          # Start interactive mode with all tools
    python cli.py --toolsets web,terminal  # Start with specific toolsets
    python cli.py --skills reames-dev,github-auth
...
os.environ["REAMES_QUIET"] = "1"  # Our own modules
...
try:
    from reames_cli.pt_input_extras import (
...
from reames_cli.banner import _format_context_length, format_banner_version_label
...
from reames_cli.browser_connect import (
...
def load_cli_config() -> Dict[str, Any]:
    ...
    If REAMES_IGNORE_USER_CONFIG=1 is set (via ``hermes chat --ignore-user-config``),
    ...
    ignore_user_config = os.environ.get("REAMES_IGNORE_USER_CONFIG") == "1"
    ...
    if config_path.exists():
        try:
            with open(config_path, "r", encoding="utf-8") as f:
                from reames_cli.config import _normalize_root_model_keys
    ...
    _is_gateway = os.environ.get("_REAMES_GATEWAY") == "1"
...
try:
    from reames_logging import setup_logging
...
try:
    from reames_cli.skin_engine import init_skin_from_config
...
def get_tool_definitions(*args, **kwargs):
    from reames_cli.mcp_startup import wait_for_mcp_discovery
...
from reames_cli.banner import build_welcome_banner
from reames_cli.commands import SlashCommandCompleter, SlashCommandAutoSuggest
...
from reames_cli.callbacks import prompt_for_secret
...
def _run_state_db_auto_maintenance(session_db) -> None:
    ...
    :func:`reames_cli.config.load_config` (the authoritative loader that
...
def _run_checkpoint_auto_maintenance() -> None:
    ...
    :func:`reames_cli.config.load_config`. Honours ``auto_prune`` /
...
def _install_skin_light_mode_hook() -> None:
    ...
    try:
        from reames_cli.skin_engine import SkinConfig  # type: ignore[import]
    except Exception:
        return
...
class _SkinAwareAnsi:
    ...
    def __str__(self) -> str:
        if self._cached is None:
            try:
                from reames_cli.skin_engine import get_active_skin
...
from reames_constants import is_termux as _is_termux_environment
...
def _build_compact_banner() -> str:
    ...
    if skin_name == "default":
        ...
        agent_name = _skin.get_branding("agent_name", "Reames Agent") if _skin else "Reames Agent"
        line1 = f"{agent_name} - AI Agent Framework"
        tiny_line = agent_name

    if os.environ.get("HERMES_FAST_STARTUP_BANNER") == "1":
        from reames_cli import __release_date__ as _release_date
        from reames_cli import __version__ as _version

        version_line = f"Reames Agent v{_version} ({_release_date})"
    else:
...
def _get_plugin_cmd_handler_names() -> set:
    ...
    try:
        from reames_cli.plugins import get_plugin_commands
...
class ReamesCLI:
    ...
    def __init__(
        ...
        if self.model == _DEFAULT_CONFIG_MODEL:
            ...
            if "localhost" in _base_url or "127.0.0.1" in _base_url:
                from reames_cli.runtime_provider import _auto_detect_local_model
    ...
    def set_voice_record_key_cache(self, raw_key: object) -> None:
        ...
        """
        try:
            from reames_cli.voice import format_voice_record_key_for_status
    ...
    def _build_status_bar_text(self, width: Optional[int] = None) -> str:
        ...
        try:
            ...
            return f"◆ {self.model if getattr(self, 'model', None) else 'Reames'}"
    ...
    def _normalize_model_for_provider(self, resolved_provider: str) -> bool:
        ...
        try:
            from reames_cli.model_normalize import (
        ...
        if resolved_provider == "copilot":
            try:
                from reames_cli.models import copilot_model_api_mode, normalize_copilot_model_id
        ...
        if resolved_provider in {"opencode-zen", "opencode-go"}:
            try:
                from reames_cli.models import normalize_opencode_model_id, opencode_model_api_mode
    ...
    def show_banner(self):
        ...
        from reames_cli.model_switch import is_nous_hermes_non_agentic
    ...
    def _try_attach_clipboard_image(self) -> bool:
        ...
        """
        from reames_cli.clipboard import save_clipboard_image
    ...
    def _handle_paste_command(self):
        ...
        from reames_cli.clipboard import has_clipboard_image
    ...
    def show_help(self):
        ...
        from reames_cli.commands import COMMANDS_BY_CATEGORY

        try:
            from reames_cli.skin_engine import get_active_help_header
    ...
    def _show_recent_sessions(self, *, reason: str = "history", limit: int = 10) -> bool:
        ...
        from reames_cli.main import _relative_time
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from reames_cli.main import _resolve_session_by_name_or_id
    ...
    def _run_curses_picker(self, title: str, items: list[str], default_index: int = 0) -> int | None:
        ...
        import threading
        from reames_cli.curses_ui import curses_single_select
    ...
    def _handle_model_picker_selection(self, persist_global: bool = False) -> None:
        ...
        if stage == "provider":
            ...
            if not model_list:
                try:
                    from reames_cli.models import provider_model_ids
        ...
        if stage == "model":
            ...
            if selected < len(model_list):
                from reames_cli.model_switch import switch_model
    ...
    def _handle_model_switch(self, cmd_original: str):
        ...
        """
        from reames_cli.model_switch import switch_model, parse_model_flags
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to reames_cli.curator so the CLI and the `hermes curator`
        ...
        try:
            from reames_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to reames_cli.skills_hub."""
        from reames_cli.skills_hub import handle_skills_slash
    ...
    def process_command(self, command: str) -> bool:
        ...
        from reames_cli.commands import resolve_command as _resolve_cmd
        ...
        if canonical in {"quit", "exit"}:
            ...
            from reames_cli.main import _print_version_info
            ...
            # Check for skill slash commands (/gif-search, /axolotl, etc.)
                ...
                from reames_cli.commands import COMMANDS
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from reames_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        """
        from reames_cli.config import load_config
        from reames_cli.colors import Colors as _Colors
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from reames_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
            model = getattr(agent, "model", None) or getattr(self, "model", None)
    ...
    def _handle_debug_command(self):
        ...
        from reames_cli.debug import run_debug_share
    ...
    def _check_config_mcp_changes(self) -> None:
        ...
        from reames_cli.config import get_config_path as _get_config_path
    ...
    def _print_exit_summary(self):
        ...
        if msg_count > 0:
            ...
            try:
                from reames_cli.skin_engine import get_active_goodbye
    ...
    def _get_tui_prompt_symbols(self) -> tuple[str, str]:
        ...
        """
        try:
            from reames_cli.skin_engine import get_active_prompt_symbol
    ...
    def _build_tui_style_dict(self) -> dict[str, str]:
        ...
        try:
            from reames_cli.skin_engine import get_prompt_toolkit_style_overrides
    ...
    def run(self):
        ...
        try:
            ...
            _welcome_text = _welcome_skin.get_branding("welcome", "Welcome to Reames Agent! Type your message or /help for commands.")
            _welcome_color = _welcome_skin.get_color("banner_text", "#FFF8DC")
        except Exception:
            _welcome_text = "Welcome to Reames Agent! Type your message or /help for commands."
        ...
        try:
            from reames_cli.model_switch import prewarm_picker_cache_async
        ...
        try:
            ...
            if not is_seen(self.config, OPENCLAW_RESIDUE_FLAG) and detect_openclaw_residue():
                ...
                try:
                    from reames_cli.config import get_config_path as _get_cfg_path_resid
        ...
        def handle_ignored_terminal_sequence(event):
            ...
            install_ignored_terminal_sequences() in reames_cli.pt_input_extras
        ...
        try:
            ...
            if hasattr(self, '_session_db') and self._session_db and self.agent:
                ...
                if getattr(self, '_delete_session_on_exit', False):
                    try:
                        from reames_constants import get_hermes_home as _ghh
...
def _run_kanban_goal_loop_q(cli: "ReamesCLI", first_response: str) -> None:
    ...
    from reames_cli.goals import run_kanban_goal_loop as _run_loop, DEFAULT_MAX_TURNS as _DEF_TURNS
                ...
                if cli._init_agent(
                    ...
                    if isinstance(result, dict) and result.get("failed"):
                        ...
                        if os.environ.get("HERMES_KANBAN_TASK") and result.get(
                            ...
                            try:
                                from reames_cli.kanban_db import (
