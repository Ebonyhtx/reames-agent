...
from reames_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _get_git_commit(project_root: Path) -> str:
    ...
    to ``<project_root>/.reames_build_sha`` by the Dockerfile's
...
def _gateway_status() -> str:
    ...
    try:
        from reames_cli.gateway import get_gateway_runtime_snapshot
