...
from reames_constants import get_default_hermes_root, get_hermes_home, display_hermes_home
...
def _detect_prefix(zf: zipfile.ZipFile) -> str:
    ...
    if len(first_parts) == 1:
        ...
        if prefix in {".hermes", ".reames", "hermes", "reames"}:
            return prefix + "/"
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if profiles_dir.is_dir():
            try:
                ...
                # reames_cli.profiles might not be available (fresh install)
