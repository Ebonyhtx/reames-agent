...
from reames_cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
...
class PluginContext:
    ...
    def register_dashboard_auth_provider(self, provider) -> None:
        ...
        ``provider`` must be an instance of
        :class:`reames_cli.dashboard_auth.DashboardAuthProvider`. Used by
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        # Lazy import to avoid circular: reames_cli.main imports plugins indirectly
        from reames_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
...
class PluginManager:
    ...
    def discover_and_load(self, force: bool = False) -> None:
        ...
        if _env_enabled("HERMES_ENABLE_PROJECT_PLUGINS"):
            project_dir = get_hermes_home() / "plugins"
