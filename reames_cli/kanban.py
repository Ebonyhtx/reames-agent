...
from reames_cli import kanban_swarm as ks
from reames_cli.profiles import get_active_profile_name, get_profile_dir, seed_profile_skills
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from reames_cli import kanban_specify as spec
