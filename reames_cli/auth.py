...
from reames_cli.config import get_hermes_home, get_config_path, read_raw_config
from reames_constants import OPENROUTER_BASE_URL, secure_parent_dir
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from reames_cli.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def _load_global_auth_store() -> Dict[str, Any]:
    ...
    if os.environ.get("PYTEST_CURRENT_TEST"):
        ...
        if real_home_env:
            real_root = get_hermes_home() / "auth.json"
            try:
...
def _prompt_model_selection(
    ...
    """
    from reames_cli.models import _format_price_per_mtok
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
    from reames_cli.config import save_config, load_config
