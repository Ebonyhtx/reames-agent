...
from reames_cli.default_soul import DEFAULT_SOUL_MD
...
# Re-export from reames_constants — canonical definition lives there.
from reames_constants import get_hermes_home  # noqa: F811,E402
...
def get_custom_provider_context_length(
    ...
    used by:
      ...
      * ``reames_cli.model_switch.resolve_display_context_length`` (``/model`` confirmation display)
