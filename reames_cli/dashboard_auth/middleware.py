...
from reames_cli.dashboard_auth.base import ProviderError, RefreshExpiredError
from reames_cli.dashboard_auth.cookies import read_session_cookies
from reames_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
...
def _unauth_response(request: Request, *, reason: str) -> Response:
    ...
    """
    from reames_cli.dashboard_auth.prefix import prefix_from_request
...
async def gated_auth_middleware(
    ...
    if session is None:
        ...
        if refreshed is not None:
            ...
            from reames_cli.dashboard_auth.cookies import (
                detect_https,
                set_session_cookies,
            )
            from reames_cli.dashboard_auth.prefix import prefix_from_request
        ...
        from reames_cli.dashboard_auth.cookies import clear_session_cookies
        from reames_cli.dashboard_auth.prefix import prefix_from_request
