...
def _create_session_db_for_oneshot():
    ...
    Oneshot bypasses ``ReamesCLI._init_agent()``, so it must wire the SQLite
...
def _run_agent(
    ...
    from reames_cli.models import detect_provider_for_model
    ...
    if effective_provider is None and (model or env_model):
        ...
        if explicit_model:
            ...
            try:
                from reames_cli import model_switch as _ms
