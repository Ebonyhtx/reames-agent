...
- Keep Reames Agent cache-first: stable prompt bytes stay stable across turns, while
...
Reames Agent treats saved memory as a synthesis cache rather than as a raw transcript
cache.
