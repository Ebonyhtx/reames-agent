...
→ 已关闭 handle-relative built-in writer/checkpoint 路径安全与 durable child effect journal
→ 评估并关闭 transcript/runtime/checkpoint/workspace 跨资源断电恢复窗口
