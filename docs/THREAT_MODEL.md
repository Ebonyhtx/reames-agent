...
| 构建与发布 | 部分实现 | Go 依赖哈希、六目标 candidate、SHA256SUMS、三平台 Desktop candidate、CodeQL 和发布契约检查已建立；CLI updater 已锁定当前官方仓库、精确 GoReleaser archive 名和 Windows 包内二进制名 | 生产发布仍禁用；公开 release 实际升级/失败回滚、CLI/Windows/macOS 工件签名、notarization、provenance attestation 和可信 updater 发布链未完成 |
...
- 公网 TLS、反向代理、安全组、linger-enabled logout/reboot 常驻、备份和升级回滚；
