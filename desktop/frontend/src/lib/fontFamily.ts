...
const FONT_FAMILY_KEY = "reames-agent-font-family";
const CUSTOM_FONT_KEY = "reames-agent-font-family-custom";
const MONO_FONT_FAMILY_KEY = "reames-agent-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "reames-agent-mono-font-family-custom";
