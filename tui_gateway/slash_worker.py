"""Persistent slash-command worker — one ReamesCLI per TUI session.
...
def _run(cli: ReamesCLI, command: str) -> str:
...
def main():
    ...
    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
        cli = ReamesCLI(model=args.model or None, compact=True, resume=args.session_key, verbose=False)
