...
func TestNormalizeLegacyLongCatContextWindowsMigratesOnlyUntouchedOfficialPresets(t *testing.T) {
	c := &Config{Providers: []ProviderEntry{
		{Name: "longcat-openai", Kind: "openai", BaseURL: longCatOpenAIBaseURL, Models: []string{"LongCat-2.0"}, Default: "LongCat-2.0", PresetID: "longcat-openai", ContextWindow: legacyLongCat20ContextWindow},
		{Name: "longcat-anthropic", Kind: "anthropic", BaseURL: longCatAnthropicBaseURL + "/", Models: []string{"LongCat-2.0"}, Default: "LongCat-2.0", PresetID: "longcat-anthropic", ContextWindow: legacyLongCat20ContextWindow},
		{Name: "custom-longcat", Kind: "openai", BaseURL: longCatOpenAIBaseURL, Models: []string{"LongCat-2.0"}, Default: "LongCat-2.0", ContextWindow: legacyLongCat20ContextWindow},
		{Name: "longcat-custom-window", Kind: "openai", BaseURL: longCatOpenAIBaseURL, Models: []string{"LongCat-2.0"}, Default: "LongCat-2.0", PresetID: "longcat-openai", ContextWindow: 262_144},
		{Name: "longcat-custom-models", Kind: "openai", BaseURL: longCatOpenAIBaseURL, Models: []string{"LongCat-2.0", "LongCat-Future"}, Default: "LongCat-2.0", PresetID: "longcat-openai", ContextWindow: legacyLongCat20ContextWindow},
		{Name: "longcat-custom-endpoint", Kind: "openai", BaseURL: "https://api.longcat.chat/custom/v1", Models: []string{"LongCat-2.0"}, Default: "LongCat-2.0", PresetID: "longcat-openai", ContextWindow: legacyLongCat20ContextWindow},
		{Name: "longcat-custom-default", Kind: "openai", BaseURL: longCatOpenAIBaseURL, Models: []string{"LongCat-2.0"}, PresetID: "longcat-openai", ContextWindow: legacyLongCat20ContextWindow},
	}}
	...
	for _, index := range []int{2, 4, 5, 6} {
		if got := c.Providers[index].ContextWindow; got != legacyLongCat20ContextWindow {
			t.Fatalf("customized provider %d context_window = %d, want unchanged %d", index, got, legacyLongCat20ContextWindow)
		}
	}
