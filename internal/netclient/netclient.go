// Package netclient builds HTTP clients and proxy resolvers that share Reames Agent's
...
// NewHTTPClient returns an HTTP client with Reames Agent proxy settings applied.
