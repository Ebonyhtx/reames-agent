...
def compress_context(
    ...
    *,
    ...
    # agent._invalidate_system_prompt()  # disabled for cache stability
    new_system_prompt = agent._cached_system_prompt or agent._build_system_prompt(system_message)
